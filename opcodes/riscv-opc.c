...
static int
match_rd_nonzero_even (const struct riscv_opcode *op, insn_t insn)
{
  int rd = (insn & MASK_RD) >> OP_SH_RD;
  return ((rd & 1) == 0) && match_rd_nonzero (op, insn);
}
...
/* Vendor-specific XKalray instructions.  */
{"kv.lq", 0, INSN_CLASS_XKALRAY, "d,o(s)", MATCH_KV_LQ, MASK_KV_LQ, match_rd_even,              INSN_DREF|INSN_16_BYTE},
{"kv.lq", 0, INSN_CLASS_XKALRAY, "d,A",    0, (int) M_Lx,           match_rd_nonzero_even,      INSN_MACRO},
{"kv.sq", 0, INSN_CLASS_XKALRAY, "t,q(s)", MATCH_KV_SQ, MASK_KV_SQ, match_rs2_even,             INSN_DREF|INSN_16_BYTE},
{"kv.sq", 0, INSN_CLASS_XKALRAY, "t,A,s",  0, (int) M_Sx_FSx,       match_rs1_nonzero_rs2_even, INSN_MACRO},
