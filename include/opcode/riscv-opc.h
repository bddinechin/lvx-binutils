...
/* Vendor-specific (Kalray) instructions.  */
#define MATCH_KV_LQ 0x7003
#define MASK_KV_LQ  0x707f
#define MATCH_KV_SQ 0x4023
#define MASK_KV_SQ  0x707f
...
/* Vendor-specific (Kalray) instructions.  */
DECLARE_INSN(kv_lq, MATCH_KV_LQ, MASK_KV_LQ)
DECLARE_INSN(kv_sq, MATCH_KV_SQ, MASK_KV_SQ)
/* Vendor-specific (T-Head) XTheadBa instructions.  */
